...
public class UserNameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (username != null) {
            ...
            pw.println("<textarea id=\"messagesTextArea\" readonly=\"readonly\" rows=\"10\" cols=\"45\"></textarea><br/>");
            pw.println("<input type=\"text\" id=\"messageText\" size=\"50\"/>");
            pw.println("<input type=\"button\" value=\"Send\" onclick=\"sendMessage();\"/>");
            pw.println("<script>");
            pw.println("	var websocket = new WebSocket(\"ws://192.168.42.195:8080/wst/chatroomServerEndpoint\");");
